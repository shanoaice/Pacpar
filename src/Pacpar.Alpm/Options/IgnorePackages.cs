...
internal sealed unsafe class IgnorePackages(byte* handle) : AlpmStringOptionList(handle)
{
  private protected override _alpm_list_t* GetList(byte* h) => NativeMethods.alpm_option_get_ignorepkgs(h);
