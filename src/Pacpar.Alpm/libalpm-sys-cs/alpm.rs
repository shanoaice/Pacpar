...
#[doc = " PGP signature verification options"]
pub use self::_alpm_siglevel_t as alpm_siglevel_t;
#[repr(u32)]
...
#[doc = " Type of question.\n Unlike the events or progress enumerations, this enum has bitmask values\n so a frontend can use a bitmask map to supply preselected answers to the\n different types of questions."]
pub use self::_alpm_question_type_t as alpm_question_type_t;
...
#[doc = " The usage level of a database."]
pub use self::_alpm_db_usage_t as alpm_db_usage_t;
unsafe extern "C" {
...
#[doc = " Logging Levels"]
pub use self::_alpm_loglevel_t as alpm_loglevel_t;
...
#[doc = " Method used to validate a package."]
pub use self::_alpm_pkgvalidation_t as alpm_pkgvalidation_t;
unsafe extern "C" {
...
#[doc = " Transaction flags"]
pub use self::_alpm_transflag_t as alpm_transflag_t;
unsafe extern "C" {
